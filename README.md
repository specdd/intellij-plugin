# SpecDD Language Support

SpecDD Language Support is an IntelliJ Platform plugin for working with SpecDD `.sdd` specification files.

SpecDD is an SDD framework for Specification-Driven Development: source-adjacent specifications that describe
structure, behavior, constraints, and implementation authority next to the code they govern. Learn more at
[specdd.ai][specdd].
...
plugin manifest is [plugin.xml][file:plugin.xml].
